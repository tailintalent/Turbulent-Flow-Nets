...
class LES(nn.Module):
    ...
    def forward(self, xx):
        ...
        u_tilde = self.spatial_filter(xx.reshape(xx.shape[0]*xx.shape[1], 1, 256, 1792)).reshape(xx.shape[0], xx.shape[1], 256, 1792)
        ...
        # u_mean
        u_tilde2 = u_tilde.reshape(u_tilde.shape[0], u_tilde.shape[1]//2, 2, 256, 1792)
        ...
        u_mean = u_mean.reshape(u_mean.shape[0], -1, 256, 1792)
